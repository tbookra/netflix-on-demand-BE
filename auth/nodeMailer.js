...
const sendEmail = async (userObj ,type) =>{
    const register_message =  {
        subject: 'wellcome to NETFLIXonDEMAND',
        text: 'You have successfully registered!',
        html: `<b> wellcome abord ${userObj.full_name}</b><br>
        <form action= "${NGROK_PATH_CLIENT}/auth/ConfirmationAccepted/${userObj.email}/${userObj.rememberMe}" mothod="get" target="_self">
